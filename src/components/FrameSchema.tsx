...
const ZONE_POLYS: Record<ZoneKey, string> = {
  front_pillar: "340,620 340,500 365,420 395,360 460,360 470,420 450,500 450,620",
  center_pillar: "540,620 540,420 555,360 595,360 600,420 595,620",
  rear_pillar: "700,620 705,420 725,355 775,350 780,420 765,620",
  sill: "330,605 765,605 765,640 330,640",
  side_beam: "470,520 540,520 540,545 470,545 M 600,520 700,520 700,545 600,545",
};

const SIDE_BEAM_POLYS = [
  "470,520 540,520 540,545 470,545",
  "600,520 700,520 700,545 600,545",
];

...
function TopView({ zoneProps }: { zoneProps: ZoneProps }) {
  ...
  return (
    ...
    >
      ...
      <path d="M358,568 C384,560 410,558 432,562 C436,634 436,716 432,792 C408,798 380,796 356,790 C350,716 350,642 358,568 Z" {...overlay("lfwin")} />
      <path d="M666,568 C640,560 614,558 592,562 C588,634 588,716 592,792 C616,798 644,796 668,790 C674,716 674,642 666,568 Z" {...overlay("rfwin")} />
      <path d="M358,808 C384,802 410,802 432,806 C436,866 436,932 432,980 C408,986 380,986 356,980 C350,924 350,866 358,808 Z" {...overlay("lrwin")} />
      <path d="M666,808 C640,802 614,802 592,806 C588,866 588,932 592,980 C616,986 644,986 668,980 C674,924 674,866 666,808 Z" {...overlay("rrwin")} />
      {/* Пороги */}

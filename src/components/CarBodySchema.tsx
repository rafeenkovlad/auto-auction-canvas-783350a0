...
function TopView({ zoneProps }: { zoneProps: ZoneProps }) {
  ...
  return (
    ...
    >
      ...
      <path d="M770,576 C748,566 712,564 690,572 L690,792 C710,800 746,800 770,790 C776,720 776,648 770,576 Z" {...overlay("rfwin")} />
      <path d="M302,808 C322,802 344,802 358,808 L358,978 C344,986 322,986 302,980 C296,924 296,866 302,808 Z" {...overlay("lrwin")} />
      <path d="M722,808 C702,802 680,802 666,808 L666,978 C680,986 702,986 722,980 C728,924 728,866 722,808 Z" {...overlay("rrwin")} />
      {/* Пороги */}

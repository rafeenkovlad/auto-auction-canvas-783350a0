...
function TopView({ zoneProps }: { zoneProps: ZoneProps }) {
  ...
  // Координаты выверены по силуэту авто на фоновом PNG (bbox ~ x:215–810, y:150–1490)
  ...
  return (
    ...
    >
      ...
      {/* Кликабельные зоны — контуры повторяют силуэт авто на подложке */}
      {/* Передний бампер — тонкая дуга поперёк носа */}
      <path d="M300,158 Q512,128 724,158 Q732,196 722,222 Q512,200 302,222 Q292,196 300,158 Z" {...overlay("fbumper")} />
      {/* Передние крылья — клин от бампера до A-стойки */}
      <path d="M222,226 Q256,222 302,226 L302,540 Q272,548 244,558 Q224,470 220,360 Q220,280 222,226 Z" {...overlay("flfender")} />
      <path d="M802,226 Q768,222 722,226 L722,540 Q752,548 780,558 Q800,470 804,360 Q804,280 802,226 Z" {...overlay("frfender")} />
      {/* Капот — трапеция, нижняя кромка общая с лобовым */}
      <path d="M302,228 Q512,214 722,228 Q732,380 720,528 Q512,548 304,528 Q292,380 302,228 Z" {...overlay("hood")} />
      {/* Лобовое стекло — трапеция, расширяется к крыше */}
      <path d="M314,540 Q512,560 710,540 Q716,650 708,752 Q512,738 316,752 Q308,650 314,540 Z" {...overlay("windshield")} />
      {/* Крыша */}
      <path d="M346,756 L678,756 L678,1014 L346,1014 Z" {...overlay("roof")} />
      {/* Двери */}
      <path d="M218,670 L344,670 L344,890 L218,890 Z" {...overlay("fldoor")} />
      <path d="M680,670 L806,670 L806,890 L680,890 Z" {...overlay("frdoor")} />
      ...
      {/* Боковые окна — между крышей и дверью */}
      <path d="M346,758 L508,758 L508,890 L346,890 Z" {...overlay("lfwin")} />
      <path d="M516,758 L678,758 L678,890 L516,890 Z" {...overlay("rfwin")} />
      <path d="M346,892 L508,892 L508,1014 L346,1014 Z" {...overlay("lrwin")} />
      <path d="M516,892 L678,892 L678,1014 L516,1014 Z" {...overlay("rrwin")} />
      {/* Пороги — узкие полосы вдоль дверей */}
      ...
      <path d="M316,1016 Q512,1034 708,1016 Q712,1108 700,1180 Q512,1162 324,1180 Q312,1108 316,1016 Z" {...overlay("rear_window")} />
      {/* Задние крылья — клин от C-стойки до кормы */}
      <path d="M218,1018 Q252,1016 302,1020 Q300,1160 296,1318 Q256,1310 236,1294 Q216,1200 218,1018 Z" {...overlay("rlfender")} />
      <path d="M806,1018 Q772,1016 722,1020 Q724,1160 728,1318 Q768,1310 788,1294 Q808,1200 806,1018 Z" {...overlay("rrfender")} />
      {/* Крышка багажника */}
      <path d="M304,1182 Q512,1162 720,1182 L712,1326 Q512,1310 312,1326 Z" {...overlay("trunk")} />
      {/* Задний бампер — дуга поперёк кормы */}
      <path d="M298,1330 Q512,1316 726,1330 Q736,1408 728,1452 Q512,1500 296,1452 Q288,1408 298,1330 Z" {...overlay("rbumper")} />

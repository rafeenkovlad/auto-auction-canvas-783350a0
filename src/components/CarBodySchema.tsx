...
function TopView({ zoneProps }: { zoneProps: ZoneProps }) {
  ...
  // Координаты выверены по силуэту авто (bbox ~ x:265–770, y:95–1270)
  ...
  return (
    ...
    >
      ...
      {/* Кликабельные зоны — контуры повторяют силуэт авто, как на референсе */}
      {/* Передний бампер — тонкая дуга поперёк носа */}
      <path d="M312,148 Q512,92 712,148 Q716,170 708,186 Q512,150 316,186 Q308,170 312,148 Z" {...overlay("fbumper")} />
      {/* Передние крылья — клин от бампера до A-стойки */}
      <path d="M276,188 Q300,184 348,188 L348,468 Q318,476 290,484 Q274,420 272,330 Q272,240 276,188 Z" {...overlay("flfender")} />
      <path d="M748,188 Q724,184 676,188 L676,468 Q706,476 734,484 Q750,420 752,330 Q752,240 748,188 Z" {...overlay("frfender")} />
      {/* Капот — трапеция, сужается к носу, нижняя кромка общая с лобовым */}
      <path d="M348,190 Q512,178 676,190 Q686,330 670,458 Q512,476 354,458 Q338,330 348,190 Z" {...overlay("hood")} />
      {/* Лобовое стекло — трапеция, расширяется к крыше */}
      <path d="M354,460 Q512,478 670,460 Q678,560 670,640 Q512,628 354,640 Q346,560 354,460 Z" {...overlay("windshield")} />
      {/* Крыша */}
      <path d="M368,644 L656,644 L656,1018 L368,1018 Z" {...overlay("roof")} />
      {/* Двери */}
      <path d="M272,644 L366,644 L366,830 L272,830 Z" {...overlay("fldoor")} />
      <path d="M658,644 L752,644 L752,830 L658,830 Z" {...overlay("frdoor")} />
      <path d="M272,832 L366,832 L366,1018 L272,1018 Z" {...overlay("rldoor")} />
      <path d="M658,832 L752,832 L752,1018 L658,1018 Z" {...overlay("rrdoor")} />
      {/* Боковые окна */}
      <path d="M368,646 L508,646 L508,830 L368,830 Z" {...overlay("lfwin")} />
      <path d="M516,646 L656,646 L656,830 L516,830 Z" {...overlay("rfwin")} />
      <path d="M368,832 L508,832 L508,1016 L368,1016 Z" {...overlay("lrwin")} />
      <path d="M516,832 L656,832 L656,1016 L516,1016 Z" {...overlay("rrwin")} />
      {/* Пороги (side_left / side_right) — узкие полосы вдоль дверей */}
      <path d="M262,648 L272,648 L272,1018 L262,1018 Z" {...overlay("lthresh")} />
      <path d="M752,648 L762,648 L762,1018 L752,1018 Z" {...overlay("rthresh")} />
      {/* Заднее стекло — трапеция, сужается к корме */}
      <path d="M354,1020 Q512,1038 670,1020 Q664,1100 650,1138 Q512,1124 374,1138 Q360,1100 354,1020 Z" {...overlay("rear_window")} />
      {/* Задние крылья — клин от C-стойки до кормы */}
      <path d="M272,1020 Q300,1018 348,1022 Q344,1130 340,1228 Q300,1222 282,1208 Q268,1140 272,1020 Z" {...overlay("rlfender")} />
      <path d="M752,1020 Q724,1018 676,1022 Q680,1130 684,1228 Q724,1222 742,1208 Q756,1140 752,1020 Z" {...overlay("rrfender")} />
      {/* Крышка багажника */}
      <path d="M350,1140 Q512,1124 674,1140 L666,1230 Q512,1220 358,1230 Z" {...overlay("trunk")} />
      {/* Задний бампер — дуга поперёк кормы */}
      <path d="M316,1232 Q512,1222 708,1232 Q716,1252 712,1268 Q512,1322 312,1268 Q308,1252 316,1232 Z" {...overlay("rbumper")} />

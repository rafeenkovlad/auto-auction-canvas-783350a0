...
function TopView({ zoneProps }: { zoneProps: ZoneProps }) {
  ...
  // Координаты выверены по контурам референса (bbox ~ x:274–763, y:85–1430)
  ...
  return (
    ...
    >
      ...
      {/* Кликабельные зоны — контуры повторяют пунктирные дорожки референса */}
      {/* Передний бампер — тонкая дуга поперёк носа */}
      <path d="M338,90 Q512,72 686,90 Q706,132 700,158 Q512,138 324,158 Q318,132 338,90 Z" {...overlay("fbumper")} />
      {/* Передние крылья — клин от бампера до A-стойки */}
      <path d="M276,200 Q300,168 348,162 L348,430 Q318,440 290,452 Q278,400 274,330 Q274,250 276,200 Z" {...overlay("flfender")} />
      <path d="M748,200 Q724,168 676,162 L676,430 Q706,440 734,452 Q746,400 750,330 Q750,250 748,200 Z" {...overlay("frfender")} />
      {/* Капот — трапеция, сужается к носу, нижняя кромка общая с лобовым */}
      <path d="M348,162 Q512,150 676,162 Q688,300 670,425 Q512,438 354,425 Q336,300 348,162 Z" {...overlay("hood")} />
      {/* Лобовое стекло — трапеция, расширяется к крыше */}
      <path d="M354,432 Q512,448 670,432 Q680,520 670,592 Q512,580 354,592 Q344,520 354,432 Z" {...overlay("windshield")} />
      {/* Крыша */}
      <path d="M368,596 L656,596 L656,1135 L368,1135 Z" {...overlay("roof")} />
      {/* Двери — внешние полосы вдоль кабины */}
      <path d="M295,596 L366,596 L366,830 L295,830 Z" {...overlay("fldoor")} />
      <path d="M658,596 L729,596 L729,830 L658,830 Z" {...overlay("frdoor")} />
      <path d="M295,832 L366,832 L366,1135 L295,1135 Z" {...overlay("rldoor")} />
      <path d="M658,832 L729,832 L729,1135 L658,1135 Z" {...overlay("rrdoor")} />
      {/* Боковые окна */}
      <path d="M368,598 L508,598 L508,830 L368,830 Z" {...overlay("lfwin")} />
      <path d="M516,598 L656,598 L656,830 L516,830 Z" {...overlay("rfwin")} />
      <path d="M368,832 L508,832 L508,1133 L368,1133 Z" {...overlay("lrwin")} />
      <path d="M516,832 L656,832 L656,1133 L516,1133 Z" {...overlay("rrwin")} />
      {/* Пороги (side_left / side_right) — узкие полосы вдоль кромки кузова */}
      <path d="M280,600 L294,600 L294,1135 L280,1135 Z" {...overlay("lthresh")} />
      <path d="M730,600 L744,600 L744,1135 L730,1135 Z" {...overlay("rthresh")} />
      {/* Заднее стекло — трапеция, сужается к корме */}
      <path d="M354,1140 Q512,1156 670,1140 Q664,1220 650,1256 Q512,1242 374,1256 Q360,1220 354,1140 Z" {...overlay("rear_window")} />
      {/* Задние крылья — клин от C-стойки до кормы */}
      <path d="M276,1140 Q300,1138 348,1142 Q344,1240 340,1346 Q300,1338 284,1320 Q270,1240 276,1140 Z" {...overlay("rlfender")} />
      <path d="M748,1140 Q724,1138 676,1142 Q680,1240 684,1346 Q724,1338 740,1320 Q754,1240 748,1140 Z" {...overlay("rrfender")} />
      {/* Крышка багажника */}
      <path d="M350,1258 Q512,1242 674,1258 L666,1348 Q512,1340 358,1348 Z" {...overlay("trunk")} />
      {/* Задний бампер — дуга поперёк кормы */}
      <path d="M338,1352 Q512,1340 686,1352 Q706,1394 700,1420 Q512,1438 324,1420 Q318,1394 338,1352 Z" {...overlay("rbumper")} />

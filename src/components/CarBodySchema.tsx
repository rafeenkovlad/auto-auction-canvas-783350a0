...
function TopView({ zoneProps }: { zoneProps: ZoneProps }) {
  ...
  return (
    ...
    >
      ...
      {/* Левый порог */}
      <path d="M280,724 L348,724 L348,1020 L298,1020 L284,870 Z" {...overlay("lthresh")} />
      {/* Правый порог */}
      <path d="M744,724 L676,724 L676,1020 L726,1020 L740,870 Z" {...overlay("rthresh")} />

      {/* Передняя левая дверь */}
      <path d="M350,724 L508,724 L508,882 L350,882 Z" {...overlay("fldoor")} />
      {/* Передняя правая дверь */}
      <path d="M516,724 L674,724 L674,882 L516,882 Z" {...overlay("frdoor")} />
      {/* Задняя левая дверь */}
      <path d="M350,888 L508,888 L508,1020 L350,1020 Z" {...overlay("rldoor")} />
      {/* Задняя правая дверь */}
      <path d="M516,888 L674,888 L674,1020 L516,1020 Z" {...overlay("rrdoor")} />

      {/* Крыша (с панорамным люком) */}
      <path d="M364,722 L660,722 L660,1014 L364,1014 Z" {...overlay("roof")} />

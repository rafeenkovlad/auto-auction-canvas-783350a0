...
function TopView({ zoneProps }: { zoneProps: ZoneProps }) {
  ...
  return (
    ...
    >
      ...
      {/* Контуры зон — построены по референсу-блюпринту, наложены на фото */}
      {/* Передний бампер — округлая дуга поперёк носа */}
      <path d="M298,156 C400,118 624,118 726,156 C736,182 734,206 720,224 C612,196 412,196 304,224 C290,206 288,182 298,156 Z" {...overlay("fbumper")} />
      {/* Переднее левое крыло — арка от бампера к A-стойке */}
      <path d="M226,230 C260,224 296,224 304,230 L304,536 C282,544 256,554 240,560 C224,488 218,408 220,332 C220,288 222,254 226,230 Z" {...overlay("flfender")} />
      {/* Переднее правое крыло */}
      <path d="M798,230 C764,224 728,224 720,230 L720,536 C742,544 768,554 784,560 C800,488 806,408 804,332 C804,288 802,254 798,230 Z" {...overlay("frfender")} />
      {/* Капот — трапеция с плавными углами, низ общий с лобовым */}
      <path d="M306,232 C400,218 624,218 718,232 C732,320 734,440 720,532 C612,548 412,548 304,532 C290,440 292,320 306,232 Z" {...overlay("hood")} />
      {/* Лобовое стекло */}
      <path d="M316,540 C400,560 624,560 708,540 C720,620 720,690 706,752 C612,738 412,738 318,752 C304,690 304,620 316,540 Z" {...overlay("windshield")} />
      {/* Крыша — прямоугольник со скруглёнными углами */}
      <path d="M354,758 Q346,758 346,768 L346,1004 Q346,1014 354,1014 L670,1014 Q678,1014 678,1004 L678,768 Q678,758 670,758 Z" {...overlay("roof")} />
      {/* Передняя левая дверь */}
      <path d="M218,672 L344,672 L344,888 L218,888 Z" {...overlay("fldoor")} />
      {/* Передняя правая дверь */}
      <path d="M680,672 L806,672 L806,888 L680,888 Z" {...overlay("frdoor")} />
      {/* Задняя левая дверь */}
      <path d="M218,892 L344,892 L344,1100 L218,1100 Z" {...overlay("rldoor")} />
      {/* Задняя правая дверь */}
      <path d="M680,892 L806,892 L806,1100 L680,1100 Z" {...overlay("rrdoor")} />
      {/* Боковые окна — узкие полосы между крышей и дверями */}
      <path d="M348,760 L508,760 L508,888 L348,888 Z" {...overlay("lfwin")} />
      <path d="M516,760 L676,760 L676,888 L516,888 Z" {...overlay("rfwin")} />
      <path d="M348,892 L508,892 L508,1012 L348,1012 Z" {...overlay("lrwin")} />
      <path d="M516,892 L676,892 L676,1012 L516,1012 Z" {...overlay("rrwin")} />
      {/* Пороги */}
      <path d="M204,672 L216,672 L216,1100 L204,1100 Z" {...overlay("lthresh")} />
      <path d="M808,672 L820,672 L820,1100 L808,1100 Z" {...overlay("rthresh")} />
      {/* Заднее стекло */}
      <path d="M318,1016 C412,1034 612,1034 706,1016 C718,1080 716,1138 700,1182 C612,1162 412,1162 324,1182 C306,1138 306,1080 318,1016 Z" {...overlay("rear_window")} />
      {/* Заднее левое крыло — арка от C-стойки к корме */}
      <path d="M222,1020 C262,1016 298,1018 304,1024 C302,1140 298,1240 296,1318 C264,1314 240,1300 230,1286 C216,1232 214,1140 218,1060 C218,1042 220,1028 222,1020 Z" {...overlay("rlfender")} />
      {/* Заднее правое крыло */}
      <path d="M802,1020 C762,1016 726,1018 720,1024 C722,1140 726,1240 728,1318 C760,1314 784,1300 794,1286 C808,1232 810,1140 806,1060 C806,1042 804,1028 802,1020 Z" {...overlay("rrfender")} />
      {/* Крышка багажника */}
      <path d="M306,1186 C412,1166 612,1166 718,1186 C720,1232 718,1284 712,1326 C612,1310 412,1310 312,1326 C306,1284 304,1232 306,1186 Z" {...overlay("trunk")} />
      {/* Задний бампер — округлая дуга поперёк кормы */}
      <path d="M298,1332 C400,1316 624,1316 726,1332 C740,1380 740,1430 728,1454 C612,1496 412,1496 296,1454 C284,1430 284,1380 298,1332 Z" {...overlay("rbumper")} />

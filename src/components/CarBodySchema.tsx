...
function TopView({ zoneProps }: { zoneProps: ZoneProps }) {
  ...
  return (
    ...
    >
      ...
      {/* Лобовое стекло */}
      <path d="M302,472 C400,484 624,484 722,472 C730,520 730,584 722,628 C620,640 404,640 302,628 C294,584 294,520 302,472 Z" {...overlay("windshield")} />
      ...
      {/* Левый порог */}
      <path d="M232,600 C236,580 244,566 252,562 C254,640 254,910 252,988 C244,984 236,970 232,950 C228,840 228,710 232,600 Z" {...overlay("lthresh")} />
      {/* Правый порог */}
      <path d="M792,600 C788,580 780,566 772,562 C770,640 770,910 772,988 C780,984 788,970 792,950 C796,840 796,710 792,600 Z" {...overlay("rthresh")} />
      {/* Заднее стекло */}
      <path d="M324,1110 C420,1120 604,1120 700,1110 C708,1150 708,1196 700,1230 C604,1240 420,1240 324,1230 C316,1196 316,1150 324,1110 Z" {...overlay("rear_window")} />
      {/* Заднее левое крыло */}
      ...
      {/* Крышка багажника */}
      <path d="M352,1012 C420,1004 604,1004 672,1012 C680,1050 680,1080 672,1108 C604,1100 420,1100 352,1108 C344,1080 344,1050 352,1012 Z" {...overlay("trunk")} />
      {/* Задний бампер */}

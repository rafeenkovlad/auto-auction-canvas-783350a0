...
function TopView({ zoneProps }: { zoneProps: ZoneProps }) {
  ...
  return (
    ...
    >
      ...
      <path d="M398,144 Q512,134 626,144 Q700,172 724,208 Q512,196 300,208 Q324,172 398,144 Z" {...overlay("fbumper")} />
      ...
      {/* Капот: общая нижняя кромка с лобовым стеклом — точки совпадают,
          поэтому зоны не пересекаются. */}
      <path d="M348,214 L676,214 Q690,338 660,470 Q512,488 364,470 Q334,338 348,214 Z" {...overlay("hood")} />
      <path d="M364,470 Q512,488 660,470 Q672,568 656,660 Q512,646 368,660 Q352,568 364,470 Z" {...overlay("windshield")} />
      {/* roof рисуется ПЕРВЫМ среди элементов кабины, чтобы оконные зоны
          оставались наверху и были кликабельны */}
      ...
      <path d="M300,1244 Q512,1234 724,1244 Q700,1284 626,1300 Q512,1310 398,1300 Q324,1284 300,1244 Z" {...overlay("rbumper")} />

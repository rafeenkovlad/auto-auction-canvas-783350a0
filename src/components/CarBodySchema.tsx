...
function TopView({ zoneProps }: { zoneProps: ZoneProps }) {
  ...
  return (
    ...
    >
      ...
      <path d="M348,728 L362,728 L362,808 L348,808 Z" {...overlay("lfwin")} />
      <path d="M662,728 L676,728 L676,808 L662,808 Z" {...overlay("rfwin")} />
      <path d="M348,812 L362,812 L362,994 L348,994 Z" {...overlay("lrwin")} />
